...
def generate_response(user_input):
    ...
    messages = [{"role": "system", "content": persona + " " + comparison_instruction}] + conversation_history
...
def troubleshooting():
    ...
    solution = troubleshooting_guide.get(issue, "Sorry, I don't have a solution for that issue. Please contact customer support.")
...
def faq():
    ...
    answer = faq_guide.get(question, "Sorry, I don't have an answer for that question. Please check our website for more information.")
